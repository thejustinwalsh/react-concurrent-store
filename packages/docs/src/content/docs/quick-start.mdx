...
1. **Install the package**
   ...
   <Tabs syncKey="package-manager">
     <TabItem label="npm">
       <Code code={`npm install react-concurrent-store`} lang="sh" />
     </TabItem>
     <TabItem label="yarn">
       <Code code={`yarn add react-concurrent-store`} lang="sh" />
     </TabItem>
     <TabItem label="pnpm">
       <Code code={`pnpm add react-concurrent-store`} lang="sh" />
     </TabItem>
     <TabItem label="bun">
       <Code code={`bun add react-concurrent-store`} lang="sh" />
     </TabItem>
   </Tabs>
